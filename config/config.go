...
func Load() Config {
	...
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefault("POSTGRES_DATABASE", "Exam3"))
	...
	cfg.ServiceName = cast.ToString(getOrReturnDefault("SERVICE_NAME", "exam_api_gateway"))
